...
type Config struct {
	...
	KAFKA_TOPIC_MESSAGES            string
	KAFKA_TOPIC_ML_ANALYZE_MESSAGES string
...
func Load() *Config {
	return &Config{
		...
		KAFKA_TOPIC_ML_ANALYZE_MESSAGES: getEnv("KAFKA_TOPIC_ML_ANALYZE_MESSAGES", "ml_analyze_messages"),
